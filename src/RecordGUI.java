...
public class RecordGUI extends JFrame implements ActionListener, KeyListener {
    ...
    try {
        ...
        RecordsHandling.loadRecordsToTable(); // loads existing data to table after opening RecordGUI
    ...
    public static RecordGUI getInstance() { // calls RecordGUI constructor if not instantiated
    ...
    public static boolean isInstantiated() { // checks if RecordGUI constructor is instantiated
